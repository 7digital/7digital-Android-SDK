...
/**
 * An {@link uk.co.sevendigital.android.sdk.util.external.Escaper} that converts literal text into a format safe for
...
public abstract class UnicodeEscaper implements Escaper {
   ...
   * of any surrogate characters encountered or provide a clearObjectGraph warning to users
   * that your escaper does not validate its input.
   *
   * <p>See {@link uk.co.sevendigital.android.sdk.util.external.PercentEscaper} for an example.
   *
   ...
   * {@link uk.co.sevendigital.android.sdk.util.external.PercentEscaper} more than doubled the performance for unescaped
